...
text = open(path.join(d, fpath),encoding ='utf-8').read()
...
# 设置背景图片
back_coloring = imread(path.join(d, "比丢.jpg"))

wc = WordCloud( font_path='C:\Windows\Fonts\STHUPO.TTF',#设置字体
